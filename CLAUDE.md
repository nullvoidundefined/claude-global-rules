...
R-228: Prefer destructuring over dot-notation. When accessing two or more properties from the same object, destructure at the top of the block. Single-property access may use dot notation.
