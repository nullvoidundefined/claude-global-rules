#!/usr/bin/env bash
# PostToolUse(Write|Edit) hook: nudge toward composed, short functions (R-227).
#
...
# restating the R-227 composition checklist. Silent for clean files and for
