...
**Preferred model: Opus.** This role is explicitly about strategic ambiguity: catching fatal flaws, unsustainable unit economics, organizational self-deception, and moat delusion. The reasoning is open-ended and the cost of a missed insight is high. Do not run this audit on Sonnet.
