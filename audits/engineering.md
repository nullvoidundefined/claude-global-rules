...
**Model routing: agent frontmatter controls.** The `agents/audit-engineering.md` definition sets the model. Default is Sonnet; step up to Opus for cross-cutting architecture reviews or pre-launch sweeps.
...
- **Performance**: N+1 queries, bundle size, caching strategy, cold start
