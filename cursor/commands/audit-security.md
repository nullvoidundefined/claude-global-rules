...
Delegate this to the `audit-security` subagent. If subagents are unavailable in this Cursor build, read `~/.claude/agents/audit-security.md` and carry out that role definition in this conversation, honoring its model-routing and output-discipline sections.
