...
Delegate this to the `audit-engineering` subagent. If subagents are unavailable in this Cursor build, read `~/.claude/agents/audit-engineering.md` and carry out that role definition in this conversation, honoring its model-routing and output-discipline sections.
