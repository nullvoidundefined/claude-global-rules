...
- **Write the handoff.** The session-handoff pattern at `docs/audits/YYYY-MM-DD-session-handoff.md` is exactly the tool for preserving state across session boundaries. Keep it under 8KB; bullets, not prose. See R-302.
