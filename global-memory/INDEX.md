...
- [`feedback_explain_terms.md`](./feedback_explain_terms.md): Explain every tool, service, or environment term on first use: what it is, where it runs, why it matters (R-210).
