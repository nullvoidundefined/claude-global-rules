...
`/Users/[REDACTED]/.claude/settings.json:7`
```
"model": "fable",
```
...
`/Users/[REDACTED]/.claude/agents/audit-engineering.md:14` and `:43`, `/Users/[REDACTED]/.claude/agents/audit-security.md:14`, `:48`, `:64`, `/Users/[REDACTED]/.claude/agents/audit-criticism.md:14`, `:16`, `:65` all cite:
```
