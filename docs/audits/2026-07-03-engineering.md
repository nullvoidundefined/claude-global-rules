...
`/Users/iangreenough/.claude/settings.json:7`
```
"model": "fable",
```
...
`/Users/iangreenough/.claude/agents/audit-engineering.md:14` and `:43`, `/Users/iangreenough/.claude/agents/audit-security.md:14`, `:48`, `:64`, `/Users/iangreenough/.claude/agents/audit-criticism.md:14`, `:16`, `:65` all cite:
```
