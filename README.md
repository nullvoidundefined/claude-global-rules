...
| 6. Hooks | mechanical | Behavioral rules that decay under pressure; mechanical at-the-tool-call layer | `hooks/`, wired in `settings.json` (40 scripts across 6 events) |
...
│   └── ...                          # 30 more gates; each self-documenting in its header.
